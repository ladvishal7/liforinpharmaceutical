        ...
        <div class="row">
          ...
          <div class="col-sm-12 col-md-12 col-lg-8">
            <div class="contact-panel">
              <form class="contact-panel-form" action="en-email.php" method="post" id="contactForm1">
                <div class="row">
                  <div class="col-sm-12">
                  ...
                  <div class="col-sm-4 col-md-4 col-lg-4">
                    <div class="form-group form-group-date">
                      ...
                      <input type="date" class="form-control"  name="date" onclick="this.showPicker()" required>
                    </div>
                  </div><!-- /.col-lg-4 -->
                  <div class="col-sm-4 col-md-4 col-lg-4">
                    <div class="form-group form-group-date">
                      <label for="time">Time (required)</label>
                      <input type="time" class="form-control"  name="time" onclick="this.showPicker()" required>
                    </div>
                  </div><!-- /.col-lg-4 -->
                  <div class="col-12">
                    <div class="form-group mb-20">
                      ...
                      <div class="d-flex flex-wrap checkbox-controls">
                        <div class="custom-control custom-checkbox">
                          <input type="checkbox" class="custom-control-input"  name="special_hours[]" value="Open before 8:00 am" id="customCheck6">
                          <label class="custom-control-label" for="customCheck6"> Open before 8:00 am</label>
                        </div>
                        <div class="custom-control custom-checkbox">
                          <input type="checkbox" class="custom-control-input"  name="special_hours[]" value="Wheelchair Accessible" id="customCheck7">
                          <label class="custom-control-label" for="customCheck7">Wheelchair Accessible</label>
                        </div>
                        <div class="custom-control custom-checkbox">
                          <input type="checkbox" class="custom-control-input"  name="special_hours[]" value="Open Saturdays" id="customCheck8">
                          <label class="custom-control-label" for="customCheck8">Open Saturdays</label>
                        </div>
                        <div class="custom-control custom-checkbox">
                          <input type="checkbox" class="custom-control-input"  name="special_hours[]" value="Serving Customers with Autism" id="customCheck9">
                          <label class="custom-control-label" for="customCheck9"> Serving Customers with Autism</label>
                        </div>
                        <div class="custom-control custom-checkbox">
                          <input type="checkbox" class="custom-control-input"  name="special_hours[]"  value="24 Hour Holter Monitoring" id="customCheck10">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" placeholder="28, Gandhinagar Society" name="address" id="address">
                    </div>
                  </div><!-- /.col-lg-12 -->
                  <div class="col-sm-6 col-md-6 col-lg-6">
                    <div class="form-group">
                      <label for="city">City</label>
                      <input type="text" class="form-control" placeholder="Navsari" name="city" id="city">
                    </div>
                  </div><!-- /.col-lg-6 -->
                  <div class="col-sm-6 col-md-6 col-lg-6">
                    <div class="form-group">
                      <label for="zip">Zip</label>
                      <input type="text" class="form-control" placeholder="396445" name="zip" id="zip">
                    </div>
                  </div><!-- /.col-lg-6 -->
                  <div class="col-12">
                    <div class="form-group">
                      <label for="details">Additional Details</label>
                      <textarea class="form-control" placeholder="Details" name="message" id="details" rows="6"></textarea>
                    </div>
