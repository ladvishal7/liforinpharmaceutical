						...
						<div class="col-md-12">
							<div class="portlet box green">
								<div class="portlet-title">
									<div class="caption">
										<i class="fa fa-list"></i>Activitie Add </div>
									<div class="tools">
								...
								<div class="portlet-body form">
									<!-- BEGIN FORM-->
									<form action="activitie_addcode" class="form-horizontal" method="post" enctype="multipart/form-data">
										<div class="form-body">
											<!-- <div class="form-group">
												<label class="col-md-3 control-label">Title</label>
												<div class="col-md-6">
													<input type="text" name="title" value="" class="form-control input-circle" required>
												</div>
											</div> -->
											<div class="form-group">
											...
											<?php /* <div class="form-group">
												...
												<div class="col-md-6">
													<input type="date" name="date" class="form-control input-circle" >
												</div>
											</div>  */ ?>
											...
											<div class="form-group">
												...
												<div class="col-md-6">
												<textarea type="text" name="location" class="form-control input-circle ckeditor" cols="30" rows="4" required></textarea>
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-md-6">
													<input type="file" class="from-control input-circle" name="file" accept="image/*" required><br>
                                           ...
                                           <!--  <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <input type="file" class="from-control input-circle" name="icon" accept="image/*" required><br>
                                                ...
                                                <div class="col-md-6">
                                                    <input type="file" class="from-control input-circle" name="file2" accept="image/*" required><br>
                                                    <caption>Image Size : 280 *  350 px</caption><br><br>
                                                </div>
                                            </div> -->
                                            <!-- <div class="form-group">
												...
												<div class="col-md-6">
													<input type="file" name="pdf" value="" accept=".pdf" class="form-control input-circle" onchange="validateFileSize(this)"><br>
                                            ...
                                            <div class="form-group">
												...
												<div class="col-md-6">
													<input type="file" name="docx" value="" accept=".doc,.docx" class="form-control input-circle" onchange="validateFileSize(this)"><br>
