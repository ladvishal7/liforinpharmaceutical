                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                <a href="menu.php">Category Index</a>
                                <i class="fa fa-circle"></i>
                            </li>
                            <li>
						...
						<div class="col-md-12">
							<div class="portlet box green">
									<div class="portlet-title">
										<div class="caption">
											<i class="fa fa-list"></i>Category Add </div>
										<div class="tools">
										...
										<div class="portlet-body form">
											<!-- BEGIN FORM-->
											<form action="our_services_addcode" class="form-horizontal" method="post" enctype="multipart/form-data">
                                                ...
                                                <?php } ?>
                                                    ...
                                                    <div class="form-body">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-6">
                                                                <input type="text" name="video"  class="form-control input-circle" required>
                                                            </div>
                                                        </div>
                                                    </div> -->

                                                    <?php if(!empty($id) && $level == '21a2'){ ?>
                                                    <div class="form-body">
                                                        <div class="form-group">
                                                            <label class="col-md-3 control-label">Video*</label>
                                                            <div class="col-md-6">
                                                                <input type="text" name="video"  placeholder="src=https://" class="form-control input-circle" required>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-6">
                                                        <textarea type="text" name="text" class="form-control input-circle ckeditor" cols="30" rows="3" required></textarea>
                                                        </div>
                                                    </div>
                                                <?php } ?>
                                               <?php /* <div class="form-body">
                                                ...
                                                <div class="form-body">
													<div class="form-group">
														...
														<div class="col-md-6">
															<select name="sub_parent_id" id="sub_parent_id" class="form-control input-circle" >
                                                                <option value=''>select</option>
                                                                <?php /*
												...
												<div class="form-actions">
													<div class="row">
														<div class="col-md-offset-3 col-md-9">
															...
															<a href="menu.php?id=<?= $id ?>&level=<?= $level ?>" class="btn btn-circle grey-salsa btn-outline">Cancel</a>
														</div>
													</div>
												</div>
											</form>
