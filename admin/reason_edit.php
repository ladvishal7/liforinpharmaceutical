<?php
	...
	$id = $_GET['id'];
	$select = mysqli_query($conn,"SELECT * FROM reason_master where id = '".$id."' ")or die(mysqli_error($conn));
                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                <a href="about_index.php">Reason Index</a>
                                <i class="fa fa-circle"></i>
                            </li>
                            <li>
						...
						<div class="col-md-12">
							<div class="portlet box green">
									<div class="portlet-title">
										<div class="caption">
											<i class="fa fa-list"></i>Reason Edit </div>
										<div class="tools">
										...
										<div class="portlet-body form">
											<!-- BEGIN FORM-->
											<form action="reason_editcode" class="form-horizontal" method="post" enctype="multipart/form-data">
												<div class="form-body">
												...
												<div class="form-actions">
													<div class="row">
														<div class="col-md-offset-3 col-md-9">
															...
															<a href="reason_index.php" class="btn btn-circle grey-salsa btn-outline">Cancel</a>
														</div>
													</div>
												</div>
											</form>
