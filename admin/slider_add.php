						...
						<div class="col-md-12">
							<div class="portlet box green">
									<div class="portlet-title">
										<div class="caption">
											<i class="fa fa-list"></i>Slider Add </div>
										<div class="tools">
										...
										<div class="portlet-body form">
											<!-- BEGIN FORM-->
											<form action="slider_addcode" class="form-horizontal" method="post" enctype="multipart/form-data">
												<div class="form-body">
													<div class="form-group">
														<label class="col-md-3 control-label">Heading *</label>
														<div class="col-md-6">
															<input type="text" name="header"  class="form-control input-circle" required>
														</div>
													</div>
                                                    <div class="form-group">
                                                    ...
                                                    <div class="form-group">
														...
														<div class="col-md-6">
															<input type="text" name="link"  class="form-control input-circle" value="" required>
														</div>
													</div>  
                                                    <div class="form-group">
													...
													<div class="form-group">
														...
														<div class="col-md-6">
															...
															<caption>Image Size : 1920 * 850 </caption><br>
														</div>
													</div>
