<?php
  ...
  include 'connect.php';
  $select = mysqli_query($conn,"select * from message_master where  is_active = 0")or die(mysqli_error($conn));
?>
<!DOCTYPE html>
<html lang="en">
    <!--<![endif]-->
						...
						<div class="col-md-12">
							<div class="portlet box blue">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="fa fa-image"></i> Messages List </div>
                                    <div class="tools">
