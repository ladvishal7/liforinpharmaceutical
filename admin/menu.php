<?php
  ...
  if(empty($_SESSION['a_id']))
  {
    ...
    if(!empty($id)){
        $level = $_GET['level'];
	    $query=mysqli_query($conn,"select * from menu_master where is_deleted = 0 AND parent_id=$id ");
        $level =  2 ;
    }else{
	    $query=mysqli_query($conn,"select * from menu_master where is_deleted = 0 AND parent_id = 0");
    }
?>
<!DOCTYPE html>
                ...
                <div class="page-content">
							...
							<div class="modal-dialog">
								<div class="modal-content" style="margin: 0 auto;">
									<div class="modal-header">
										...
										<h4 class="modal-title" style="text-align:center;"><?php echo $_SESSION["msgg"];?></h4>
									</div>
                   ...
                   <div class="row">
						...
						<div class="text-right" style="padding:5px;">
							<a href="menu_add.php?id=<?php echo $id?>&level=<?php echo $level ?>" class="btn green">Add</a>
							<?php if(!empty($id)){ ?>
                                <a href="menu.php?level=1" class="btn green">Back</a>
                            <?php } ?>
						</div>
                                        ...
                                        <table class="table table-bordered text-center">
											...
											?>
                                                <tr>
													...
													<td> <?php if($row['level'] == 1){ echo 'Main';}else{echo'Sub-main';} ?> </td>
													<!-- <td> <?php  if(!empty($row['img'])){ ?><img src="images/<?php echo $row['img']; ?>" width="100px"/><?php }  ?> </td> -->
													<td><a href="menu_edit.php?id=<?php echo $row['id']; ?>&level=<?php echo $level ?>"><i class="fa fa-pencil-square-o" style="font-size:30px;color:green;" aria-hidden="true"></i></a></td>
                                                    <?php  if($row['level'] == 1  ){ ?>
