<?php
	...
	$id = $_GET['id'];
	$news = mysqli_query($conn,"SELECT * FROM news_master WHERE id = '".$id."' ");	
    $news_row = mysqli_fetch_assoc($news);
?>
<!DOCTYPE html>
						...
						<div class="col-md-12">
							<div class="portlet box green">
								...
								<div class="portlet-body form">
									<!-- BEGIN FORM-->
									<form action="service_updatecode" class="form-horizontal" method="post" enctype="multipart/form-data">
										...
										<div class="form-body">
											...
											<?php /*<div class="form-group">
												...
												<div class="col-md-6">
													...
													<input type="hidden" name="file_old"  value="<?php echo $news_row['news_img']; ?>" >
                                                    <img src="../images/<?php echo $news_row['news_img']; ?>" width="90px"/>
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-3 control-label">Icon</label>
												<div class="col-md-6">
													<input type="file" name="icon"  class="form-control input-circle" >
											...
											<div class="form-group">
												...
												<div class="col-md-6">
												    <textarea type="text" name="event_description" class="form-control input-circle ckeditor" cols="30" rows="3" required><?php echo $news_row['news_description']; ?></textarea>
												</div>
											</div> 
